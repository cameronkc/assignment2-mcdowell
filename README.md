...
[Read More](https://en.wikipedia.org/wiki/Sweep_line_algorithm)
                ...
                ll dot(const pt& a) const { return x _ a.x + y _ a.y; }
                ll dot(const pt& a, const pt& b) const { return (a - *this).dot(b - *this); }
                ll cross(const pt& a) const { return x _ a.y - y _ a.x; }
